...
class PilasReport(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            lpad(case when rpb.tipo_cuenta in ('corriente', 'cc') then 27
                 when rpb.tipo_cuenta in ('ahorros', 'ca') then 37 end::text,2,'00') as tipo_transaccion,
        ...
        where_ = """
        		    ...
        		    and ps.state in ('done', 'validated', 'paid')
        		"""
